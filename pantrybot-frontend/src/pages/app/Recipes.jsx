...
export default function Recipes() {
  const { loading, error, recipes, recipeDetails, searchResults, getRecipeById, deleteRecipe, searchRecipe, saveRecipe, loadRecipes } = useRecipes();
  ...
  return (
    <Container>
      <Row>
        <Col md={8} className="border-end">
          ...
          <div className="d-flex justify-content-between">
            <h2>AI Recipe Search <Search size={24} /></h2>
            <Button variant="primary" onClick={resetForm}>Reset Fields <ArrowClockwise size={24}/></Button>
          </div>
          ...
          <Form onSubmit={handleSubmit(handleSearch)}>
            <Form.Group className="mb-3" controlId="promptField">
              ...
              />
              {errors.prompt && <p className="text-danger">{errors.prompt.message}</p>} {/* Error message */}
            </Form.Group>
          ...
          <>
            <div className="d-flex justify-content-between">
              <h2>AI Recipe Search <Search size={24} /></h2>
              <Button variant="primary" onClick={handlePrevious}><ArrowLeftShort size={24}/> Back to Search</Button> 
            </div>
            <hr style={{ margin: '20px 0' }} />
            ...
            { searchLoading ? (
                ...
                <div>
                  ...
                  <p><strong>Estimated Time:</strong> {searchResults.estimatedTime} minutes</p>
      ...
      <ViewRecipeModal modal={viewModal} recipeDetails={recipeDetails} getRecipeById={getRecipeById} deleteRecipe={deleteRecipe} />
